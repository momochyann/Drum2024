...
public class LoadDll : MonoBehaviour
{
    ...
    {
        return $"https://a.unity.cn/client_api/v1/buckets/e1f234e4-47b3-4ba9-afc5-a4bed3f36da0/release_by_badge/{tagetBadge}/entry_by_path/content/?path={GetPlatformURL()}version.txt";
    }
    ...
    public async UniTaskVoid LoadStart(bool isLocal)
    {
        ...
        else
        {
            ...
            $"https://a.unity.cn/client_api/v1/buckets/e1f234e4-47b3-4ba9-afc5-a4bed3f36da0/release_by_badge/{tagetBadge}/entry_by_path/content/?path={GetPlatformURL()}{await Get_CDN_URL(CdnVersion)}";
